...
pathIN = path
pathOUT = path+'out_optimization/nominalMVA_'
...
# and tree.mvaVBF>0.9):  
           #print entry
	#if 1>0: 
        #if((tree.triggerResult[0] or tree.triggerResult[1]) and tree.mqq[1]>250 and tree.dPhibb[1]<2.0 and tree.jetPt[0]>80 and tree.jetPt[1]>65 and tree.jetPt[2]>50 and tree.jetPt[3]>35 and tree.dEtaqq[1]>2.5 and tree.nJets>3):
          # print entry 
           Bid = []
