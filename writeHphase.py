...
pathIN = path
pathOUT = path+'out_optimization/nominal_'
...
for iter in range(1,31):
    ...
    for entry in range(1,nEntries/5):
        tree.GetEntry(entry)
        ...
        #if ((tree.nJets>3) and (tree.triggerResult[9] ) and tree.mqq[2]>600 and tree.dPhibb[2]<2.0 and tree.jetPt[0]>80 and tree.jetPt[1]>65 and tree.jetPt[2]>50 and tree.jetPt[3]>35 and tree.dEtaqq[2]>2.5 and tree.jetBtagM[tree.b1[0]] and tree. jetBtagL[tree.b2[0]] and tree.mvaVBF>0.9):  
           Bid = []
